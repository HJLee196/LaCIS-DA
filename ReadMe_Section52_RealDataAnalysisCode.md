# ReadMe_Section 52 - Real Data Analysis Code
#Knockoffs
...
- It also describes the following summary files:
  - `99_SummaryAll_4_Simulation 52_realdata.R`.
...
1. `43_44_mother_code_multiLR_realdata-AllPart12.R`,`46_47_mother_code_multidecomp_realdata-AllPart12.R`, and `48_mother_code_BH_realdata.R`
   - `43_44_mother_code_multiLR_realdata-AllPart12.R`
     - Code for reproducing the multi-LR/e-LR results in the real data analysis in Section 5.2.
   - `46_47_mother_code_multidecomp_realdata-AllPart12.R`
     - Code for reproducing the multi-decomp/e-decomp results in the real data analysis in Section 5.2.
   - `48_mother_code_BH_realdata.R`
     - Code for reproducing the BH results in the real data analysis in Section A4.
   ...
   - Hyperparameters the user needs to specify:
     ...
     - `PC`: The number of latent factors.
       - For Section 5.2, PCs used are as follows:
         - Astrocyte:  43
         - Microglia: 11
         - Neuron: 13
         - Oligo: 64
     ...
     - `part1`: If `part1 = TRUE`, the code runs the knockoff generation step.
     - `part2`: If `part2 = TRUE`, the code runs the knockoff procedure step.  
       If knockoffs have already been generated and saved, you only need to run `part2`.
...
2. `99_SummaryAll_4_Simulation 52_realdata.R`
   - This code produces Table 1 in Section 5.2.
